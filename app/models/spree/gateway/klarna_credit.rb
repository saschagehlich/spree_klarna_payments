module Spree
  class Gateway
    class KlarnaCredit < Gateway
      ...
      validates :preferred_payment_method, inclusion: {in: %w( invoice pix base_account deferred_interest fixed_amount pay_now pay_later pay_over_time )}, allow_blank: true
